...
from .forms import VariationCreateForm
...
class VariationCreateView(CreateView):
    """detail view of variation"""
    model = Variation
    form_class = VariationCreateForm
    context_object_name = 'variation_create'
    template_name = 'variationtracker/variation_create.html'
